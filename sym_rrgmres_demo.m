function varargout = sym_rrgmres_demo(varargin)
% SYM_RRGMRES_DEMO M-file for sym_rrgmres_demo.fig
%       SYM_RRGMRES_DEMO, by itself, creates a new SYM_RRGMRES_DEMO or 
%       raises the existing instance.
%
%       H = SYM_RRGMRES_DEMO returns the handle to a new SYM_RRGMRES_DEMO 
%       or the handle to the existing instance.
%
%       SYM_RRGMRES_DEMO('CALLBACK',hObject,eventData,handles,...) calls 
%       the local function named CALLBACK in SYM_RRGMRES_DEMO.M with the 
%       given input arguments.
%
%       SYM_RRGMRES_DEMO('Property','Value',...) creates a new 
%       SYM_RRGMRES_DEMO or raises the existing instance.  Starting from 
%       the left, property value pairs are applied to the GUI before 
%       sym_rrgmres_demo_OpeningFcn gets called.  An unrecognized property 
%       name or invalid value makes property application stop.  All inputs 
%       are passed to sym_rrgmres_demo_OpeningFcn via varargin.
%
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help sym_rrgmres_demo

% Last Modified by GUIDE v2.5 14-May-2011 14:06:52
...
% --- Executes just before sym_rrgmres_demo is made visible.
function sym_rrgmres_demo_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sym_rrgmres_demo (see VARARGIN)

% Choose default command line output for sym_rrgmres_demo
...
% so window can get raised using sym_rrgmres_demo.
if strcmp(get(hObject,'Visible'),'off')
    %plot(rand(5));
end

% UIWAIT makes sym_rrgmres_demo wait for user response (see UIRESUME)
...
if matrix_type==1
    ...
    if discrep_Value==1
        ...
        [rrgmressol,~,~]=sym_rrgmres_dp(A,b,discrep);
        ...
        [rrgmressol]=sym_rrgmres_iter(A,b,iterations);
...
% Hints: contents = cellstr(get(hObject,'String')) returns choice contents
%        as cell array
...
%        str2double(get(hObject,'String')) returns contents of user_A as 
%        a double
...
%        str2double(get(hObject,'String')) returns contents of user_b as 
%        a double
end
